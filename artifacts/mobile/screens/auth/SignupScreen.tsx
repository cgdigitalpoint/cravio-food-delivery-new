...
export function SignupScreen({ onBack, onLogin, onSignUp }: SignupScreenProps) {
      ...
      >
        ...
        >
          <View
            style={[
              styles.checkbox,
              { backgroundColor: agreed ? '#FF6B00' : '#FFFFFF', borderColor: agreed ? '#FF6B00' : '#D1D5DB' },
            ]}
          >
          ...
          <Text style={[PP.caption, styles.termsText]}>
            I agree to the{' '}
            <Text style={{ color: '#FF6B00' }}>Terms of Service</Text> and{' '}
